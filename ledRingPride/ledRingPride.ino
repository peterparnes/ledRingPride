...
int purple[3] = { 89, 12, 20 }; 

uint32_t pride[] = { pixels.Color(0xf0, 0, 0), pixels.Color(0xff, 0x80, 00), pixels.Color(0xff, 0xff, 0), pixels.Color(0x00, 0x79, 0x40), pixels.Color(0x40, 0x40, 0xff), pixels.Color(0xa0, 0x00, 0xc0) };
#define NUMPRIDE 6
...
{
  pixels.begin();
  pixels.setBrightness(45); // brightness
  setAll(pride[0]);
...
void crossFade(int color[3]) {
  ...
  for (int i = 0; i <= 1020; i++) {
    ...
    setAll(pixels.Color(redVal, grnVal, bluVal));
    pixels.show();
